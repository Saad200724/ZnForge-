    ...
    <section className="relative min-h-screen flex items-center justify-center pt-32 sm:pt-40 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          {/* Bottom Right Avatar */}
          <div
            className="absolute -bottom-12 -right-4 sm:bottom-[10%] sm:right-[-10%] animate-float-avatar z-20 pointer-events-none"
          ...
          <h1 className="font-display text-3xl sm:text-display-md lg:text-display-xl font-bold text-foreground mb-6 animate-in delay-2 leading-[1.1]">
            ...
            Agency for Startups & Enterprises,
            <br />
            <span className="text-gradient animate-shimmer">
              Build Your Product Without a Dev Team
            </span>
          </h1>

          {/* Subheadline */}
          <p className="text-base sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed animate-in delay-3 px-4">
            We partner with startups and enterprises to create exceptional
            digital experiences that convert visitors into customers and drive
            measurable growth.
          </p>
